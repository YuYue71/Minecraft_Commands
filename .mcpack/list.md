...
├── pack.mcmeta.md                          # 資料包識別與版本核心設定檔速查表 (必要)
└── 一些有好用的資料包/                       # 專門放一些自開發的好用或有趣的資料包, 工具, 玩具
```
...
| 世界生成 | [`worldgen`](pack_template/data/example/worldgen/list.md) | 定義世界 結構, 環境, 設置 等等元素. |
